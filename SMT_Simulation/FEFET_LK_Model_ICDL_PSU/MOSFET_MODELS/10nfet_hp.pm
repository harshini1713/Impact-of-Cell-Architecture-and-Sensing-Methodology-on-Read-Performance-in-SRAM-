...
+nbody   = 2.5e+022        phig    = 4.4212           epsrox  = 26             epsrsub = 11.9          
...
+sdterm  = 0               ldg     = 2e-009          epsrsp  = 26             tgate   = 8e-009        
...
+aigbinv = '0.0111*1'        
*========================== igb ===========================*
+bigbinv = '0.03*1'            cigbinv = '0.006*1'           eigbinv = 1.1             nigbinv = '1.2'             
+aigbacc = '0.0149*1'          bigbacc = '0.000949*1'        cigbacc = '0.075*1'           nigbacc = '3*1e-13'             
+aigc    = '0.0136*1'        
*========================== igc ===========================*
+bigc    = 0.00171         cigc    = 0.075           nigc    = '1*1e-12'             
*======================== igs/igd =========================*
+dlcigs  = 0               dlcigd  = 0               aigs    = '0.0136*1'          aigd    = '0.0136*1'        
+bigs    = '0.00171*1'         bigd    = '0.00171*1'         cigs    = '0.075*1'           cigd    = '0.075*1'         
+poxedge = 1               agidl   = '5.729e-012*1'    
*======================= gidl/gisl ========================*
+agisl   = '5.729e-012*1'      bgidl   = 3e+008          bgisl   = 3e+008          egidl   = 0.1           
+egisl   = 0.1             alpha0  = 0             
*========================== isub ==========================*
...
************************************************************
*====================== capacitance =======================*
+cgsp    = 0               cgdp    = 0               cdsp    = 0               cfs     = '2.56e-011*26/3.9'     
+cfd     = '2.65e-011*26/3.9'       covs    = '2.5e-011*26/3.9'        covd    = '2.5e-011*26/3.9'        cgsl    = 0             
