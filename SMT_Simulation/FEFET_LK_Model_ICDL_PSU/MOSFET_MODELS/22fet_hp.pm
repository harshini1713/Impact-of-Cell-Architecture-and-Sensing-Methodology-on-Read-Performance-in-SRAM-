...
+dtox    = 2.5e-010        epsrox  = 22             wint    = 5e-009          lint    = 2e-009        
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref  = '1.05e-009*1e-29'     
+xl	   = -9e-9
...
+cgso    = '6.5e-011*22/3.9'        cgdo    = '6.5e-011*22/3.9'        cgbo    = '2.56e-011*22/3.9'       cgdl    = '2.653e-010*3.9/3.9'    
+cgsl    = '2.653e-010*3.9/3.9'      ckappas = 0.03            ckappad = 0.03            acde    = 1             
...
+dtox    = 3e-010          epsrox  = 26             wint    = 5e-009          lint    = 2e-009        
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref  = '1.1e-009*1e-20'      
+xl	   = -9e-9
