...
+dtox    = 2.5e-010        epsrox  = 26             wint    = 5e-009          lint    = 3.75e-009     
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref  = '1e-20*1.25e-009'     
+xl	   = -20e-9
...
+dtox    = 3e-010          epsrox  = 26             wint    = 5e-009          lint    = 3.75e-009     
+ll      = 0               wl      = 0               lln     = 1               wln     = 1             
+lw      = 0               ww      = 0               lwn     = 1               wwn     = 1             
+lwl     = 0               wwl     = 0               xpart   = 0               toxref  = '1e-20*1.3e-009'      
+xl	   = -20e-9
...
+cgso    = '1.1e-010*26/3.9'        cgdo    = '1.1e-010*26/3.9'        cgbo    = '2.56e-011*26/3.9'       cgdl    = '2.653e-010*26/3.9'    
+cgsl    = '2.653e-010*26/3.9'      ckappas = 0.03            ckappad = 0.03            acde    = 1             
+moin    = 15              noff    = 0.9             voffcv  = 0.02          
